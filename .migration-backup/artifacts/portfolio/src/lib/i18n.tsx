...
export const translations = {
  en: {
    ...
    hero: {
      ...
      cta2: "See my work",
      available: "Taking on new projects from June 2026"
    },
    services: {
      label: "Services",
  ...
  it: {
    ...
    funnel: {
      ...
      sub: "Compila il modulo e ti rispondo con un piano chiaro entro 24 ore.",
      fields: {
        name: "Il tuo nome", namePh: "Nome completo",
        email: "Email aziendale", emailPh: "tu@azienda.com",
        company: "Azienda o nome del progetto", companyPh: "Acme Srl o nome del progetto",
        service: "Cosa ti serve?",
        serviceOptions: ["App Mobile", "Landing Page", "Piattaforma Web", "Backend Personalizzato", "Non sono sicuro — parliamone"],
        budget: "Budget",
        budgetOptions: ["Meno di €500", "€500 – €1.500", "€1.500 – €3.000", "€3.000+", "Non sono sicuro"],
        timeline: "Quando ne hai bisogno?",
        timelineOptions: ["Il prima possibile", "Entro un mese", "2–3 mesi", "Nessuna fretta"],
        description: "Descrivimi il progetto",
        descriptionPh: "Cosa stai costruendo, per chi è, e come si presenta un buon risultato per te?",
        submit: "Invia il mio brief",
        submitting: "Invio in corso..."
      },
      success: { title: "Ricevuto — ti rispondo presto.", sub: "Esaminerò il tuo brief e ti invierò una proposta chiara entro 24 ore." }
    },
    ...
    testimonials: [
      ...
      { quote: "Ha costruito un sistema di prenotazioni e pagamenti per la mia attività in due settimane. Le agenzie con cui avevo lavorato non ci si avvicinavano.", name: "Luca R.", role: "Imprenditore", location: "Lecco, Italia" }
    ],
  ...
  sq: {
    ...
    hero: { badge: "I disponueshem per projekte te reja · Kosove / Itali", h1Line1: "Ndertoj produkte dixhitale", h1Line2: "qe klientet tuaj", h1Line3: "i perdorin me te vertete —", h1Line4: "dhe kthehen perseri.", sub: "Kthej idetë ne produkte reale. Aplikacione, faqe interneti dhe platforma — te nderthura per te performuar, te dorezuara ne kohe.", cta1: "Tregomë për projektin tënd", cta2: "Shiko punimet e mia", available: "Duke pranuar projekte te reja nga qershori 2026" },
    funnel: {
      label: "Fillo nje Projekt",
      title: "Tregomë për projektin tënd",
      sub: "Plotëso formularin dhe do të të kthehem me një plan të qartë brenda 24 orëve.",
      fields: {
        name: "Emri yt", namePh: "Emri i plotë",
        email: "Email biznesi", emailPh: "ti@kompania.com",
        company: "Kompania ose emri i projektit", companyPh: "Emri i kompanise ose projektit",
        service: "Cfare ke nevoje?",
        serviceOptions: ["Aplikacion Mobil", "Landing Page", "Platforme Web", "Backend i Personalizuar", "Nuk jam i sigurt — le te flasim"],
        budget: "Buxheti",
        budgetOptions: ["Nen €500", "€500 – €1,500", "€1,500 – €3,000", "€3,000+", "Nuk jam i sigurt"],
        timeline: "Kur ke nevoje?",
        timelineOptions: ["Sa me shpejt te jete e mundur", "Brenda nje muaji", "2–3 muaj", "Pa ngutje"],
        description: "Tregomë per projektin",
        descriptionPh: "Cfare po nderton, per kend eshte dhe si duket nje rezultat i mire per ty?",
        submit: "Dergo brifin tim",
        submitting: "Duke derguar..."
      },
      success: { title: "Morra — do te kontaktoj shpejt.", sub: "Do ta shqyrtoj brifin tuaj dhe do ju dergoj nje propozim te qarte brenda 24 oreve." }
    },
  ...
  de: {
    ...
    hero: { badge: "Verfügbar für neue Projekte · Kosovo / Italien", h1Line1: "Ich entwickle digitale Produkte,", h1Line2: "die deine Kunden", h1Line3: "wirklich nutzen —", h1Line4: "und immer wieder öffnen.", sub: "Ich bringe Ideen von einem Gespräch zu einem fertigen Produkt. Apps, Websites und Plattformen — gebaut für Leistung, pünktlich geliefert.", cta1: "Erzähl mir von deinem Projekt", cta2: "Meine Projekte ansehen", available: "Neue Projekte ab Juni 2026" },
    services: {
      label: "Leistungen",
      title: "Klarer Preis. Klarer Umfang. Fertig.",
      sub: "Keine versteckten Kosten, keine Verzögerungen. Jedes Projekt hat einen Festpreis und ein Lieferdatum, zu dem ich stehe.",
      items: [
        { name: "Mobile App", tagline: "Deine Idee, live im App Store und Google Play in 6 Wochen.", price: "Ab €799", timeline: "6 Wochen", desc: "Ich entwickle deine App von Anfang bis Ende — Design, Entwicklung und Einreichung in beiden Stores.", features: ["React Native", "iOS & Android", "Supabase", "App Store & Play Store Einreichung", "Push-Benachrichtigungen", "30 Tage Support nach Launch"] },
        ...
        { name: "Web-Plattform", tagline: "Ein vollständiges Webprodukt — Konten, Zahlungen, Dashboards — in 3 Wochen.", price: "Ab €1.299", timeline: "3 Wochen", desc: "Alles, was dein Unternehmen braucht, in einem Produkt.", features: ["Next.js", "Supabase / PostgreSQL", "Benutzerkonten & Login", "Admin-Dashboard", "Echtzeit-Updates", "Deployment inklusive"] },
    ...
    funnel: {
      ...
      sub: "Füll das Formular aus und ich melde mich innerhalb von 24 Stunden mit einem klaren Plan.",
      fields: {
        name: "Dein Name", namePh: "Vollständiger Name",
        email: "Geschäftliche E-Mail", emailPh: "du@unternehmen.de",
        company: "Unternehmen oder Projektname", companyPh: "Muster GmbH oder Projektname",
        service: "Was brauchst du?",
        serviceOptions: ["Mobile App", "Landing Page", "Web-Plattform", "Individuelles Backend", "Noch unsicher — lass uns reden"],
        budget: "Budget",
        budgetOptions: ["Unter €500", "€500 – €1.500", "€1.500 – €3.000", "€3.000+", "Noch unsicher"],
        timeline: "Wann brauchst du es?",
        timelineOptions: ["So schnell wie möglich", "Innerhalb eines Monats", "2–3 Monate", "Kein Zeitdruck"],
        description: "Beschreib mir das Projekt",
        descriptionPh: "Was baust du, für wen ist es, und wie sieht ein gutes Ergebnis für dich aus?",
        submit: "Brief absenden",
        submitting: "Wird gesendet..."
      },
      success: { title: "Erhalten — ich melde mich bald.", sub: "Ich werde dein Brief prüfen und dir innerhalb von 24 Stunden einen klaren Vorschlag schicken." }
    },
...
// Fill in missing properties for other languages by copying from EN as fallback
...
export function I18nProvider({ children }: { children: ReactNode }) {
  const [lang, setLangState] = useState<Lang>(() => {
    ...
    if (saved === "en" || saved === "it" || saved === "sq" || saved === "de") {
      return saved;
    }
    return "en";
  });
