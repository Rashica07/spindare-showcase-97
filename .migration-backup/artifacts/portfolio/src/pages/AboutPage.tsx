      ...
      <section className="py-20 border-b border-border/40 bg-card/20" data-testid="about-skills">
        <div className="max-w-7xl mx-auto px-6">
          <FadeUp>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight">{t.about.skills[0]?.name ? "Tech Stack" : ""}</h2>
          </FadeUp>
            ...
            {t.about.skills.map((cat, i) => (
              <FadeUp key={i} delay={i * 0.08}>
                <motion.div 
                  ...
                  transition={{ duration: 0.2 }}
                  className="border border-card-border bg-card/60 backdrop-blur-sm rounded-xl p-6 transition-colors shadow-sm" 
              ...
              {t.about.experience.map((exp, i) => (
                <FadeUp key={i} delay={i * 0.1}>
                  <div className="flex gap-8 md:gap-0 relative" data-testid={`exp-item-${i}`}>
                    <div className="hidden md:block w-32 pt-1 shrink-0">
                      <span className="font-mono text-xs text-muted-foreground">{exp.year}</span>
                    </div>
          ...
          <FadeUp delay={0.1} className="flex gap-4 shrink-0">
            <Link href="/contact" data-testid="about-cta-contact">
              <motion.span
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-primary text-primary-foreground font-semibold rounded-lg text-sm hover:bg-primary/90 transition-colors cursor-pointer"
              >
            ...
            <a
              ...
              data-testid="about-cta-github"
              className="inline-flex items-center gap-2 px-5 py-3.5 border border-border/60 text-muted-foreground hover:text-foreground rounded-lg text-sm transition-colors"
            >
