      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <section className="pt-40 pb-20 text-center" data-testid="blog-post-not-found">
          ...
          <Link href="/blog" data-testid="back-to-blog-404">
            <motion.span
              whileHover={{ x: -4 }}
              className="inline-flex items-center gap-2 mt-8 text-sm text-primary cursor-pointer"
            >
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <Link href="/blog" data-testid="back-to-blog">
              <motion.span
                whileHover={{ x: -4 }}
                className="inline-flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors cursor-pointer mb-8"
              >
      ...
      <section className="py-16" data-testid="blog-post-body">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div
            ...
            className="border border-primary/30 bg-primary/5 rounded-xl p-10 text-center relative overflow-hidden shadow-lg glow-orange-sm"
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed relative z-10">
              Full article content is being written. Check back soon — or follow on GitHub to be notified when it goes live.
            </p>
            <a
