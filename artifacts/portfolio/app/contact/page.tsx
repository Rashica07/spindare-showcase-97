...
export default function ContactPage() {
  const { t } = useLanguage();
  const overrides = usePageOverride('contact') as BlockOverrides;
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-16">
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <FadeUp delay={0.3} className="border border-primary/20 bg-primary/5 rounded-xl p-6">
              ...
              <a href="https://discord.com/users/871100378299654194" target="_blank" rel="noopener noreferrer" data-testid="contact-discord-link" className="inline-flex items-center gap-2 text-xs font-medium text-primary border border-primary/30 rounded-lg px-4 py-2 hover:bg-primary/10 transition-colors">
