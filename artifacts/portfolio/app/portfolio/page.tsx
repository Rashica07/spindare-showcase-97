...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="page-hero-glow pt-32 pb-20 border-b border-border/40 relative overflow-hidden" data-testid="portfolio-hero">
        <PageWatermark text="WORK" />
      ...
      <section className="py-16" data-testid="portfolio-grid">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {filtered.length === 0 && (
            <div className="py-20 text-center text-muted-foreground text-sm" data-testid="portfolio-empty">No projects in this category yet.</div>
          )}
        </div>
      </section>
