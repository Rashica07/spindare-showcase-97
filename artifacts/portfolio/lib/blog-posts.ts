...
const posts: BlogPostContent[] = [
...

  {
    ...
    sections: [
      ...
      { type: "p", text: "Most travel apps make you enter your destination, then your dates, then your interests, then your budget. That is five separate screens of structured input before you get anything useful. TravelMe's hypothesis is that one message is enough:" },
