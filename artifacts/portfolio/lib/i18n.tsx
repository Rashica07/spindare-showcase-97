...
export const translations = {
  ...
  it: {
    ...
    services: {
      ...
      items: [
        { name: "App Mobile", tagline: "La tua idea, live su App Store e Google Play in 6 settimane.", price: "Da €799", timeline: "6 settimane", desc: "Creo la tua app dall'inizio alla fine.", features: ["React Native", "iOS & Android", "Supabase", "Pubblicazione App Store & Play Store", "Notifiche push", "30 giorni di supporto post-lancio"] },
    ...
    work: { label: "Lavori Selezionati", title: "Progetti reali. Risultati reali.", projects: [] as never[] },
    stats: [] as never[], process: { label: "", title: "", steps: [] as never[] },
    testimonials: [
      ...
      { quote: "Lavorare con Kiqa su Spindare è stato impressionante.", name: "Biba W.", role: "Co-founder, Spindare", location: "Kosovo" },
    ...
    about: { label: "", title: "", sub: "", bio: [] as never[], skills: [] as never[], experience: [] as never[], values: [] as never[] },
    blog: { label: "", title: "", sub: "", readMore: "Leggi l'articolo", minRead: "min di lettura", categories: [] as never[], posts: [] as never[] },
    contact: { label: "Contatti", title: "Scrivimi", sub: "Parlami del tuo progetto e ti rispondo entro 24 ore.", form: { name: "Il tuo nome", namePh: "Nome completo", email: "Email", emailPh: "tu@esempio.com", subject: "Oggetto", subjectPh: "Richiesta progetto", message: "Messaggio", messagePh: "Raccontami del tuo progetto...", send: "Invia messaggio", sending: "Invio in corso...", sent: "Messaggio inviato.", sentSub: "Ti rispondo entro 24 ore.", another: "Invia un altro messaggio" }, chat: { intro: "Modulo rapido", greeting: "Ciao — sono l'assistente di raccolta di KIQA. Tre domande veloci e passo tutto a Kristian.", qService: "Di cosa hai bisogno?", qTimeline: "Quando ne hai bisogno?", qDescription: "Raccontami un po' del progetto.", descriptionPh: "Cosa stai costruendo e come si presenta un buon risultato?", qName: "Perfetto — come ti chiami?", namePh: "Nome completo", qMethod: "Ultima cosa — come deve contattarti Kristian?", methodEmail: "Email", methodPhone: "Telefono", emailPh: "tu@esempio.com", phonePh: "+355 6X XXX XXXX", submit: "Invia a Kristian", sending: "Invio in corso...", typing: "sta scrivendo", summaryIntro: "Ecco cosa ho raccolto:", restart: "Ricomincia", switchMethod: "Passa a" }, info: { email: "contact@kiqa-dev.it", discord: "@kodibkfg", github: "github.com/rashica07", location: "Kosovo / Italia", response: "Entro 24 ore" } },
  ...
  sq: {
    ...
    hero: { badge: "I disponueshem per projekte te reja · Kosove / Itali", h1Line1: "Ndertoj produkte dixhitale", h1Line2: "qe klientet tuaj", h1Line3: "i perdorin me te vertete —", h1Line4: "dhe kthehen perseri.", sub: "Kthej idetë ne produkte reale.", cta1: "Tregomë për projektin tënd", cta2: "Shiko punimet e mia", available: "Duke pranuar projekte te reja nga gushti 2026" },
    services: { label: "Sherbime", title: "Cmim i qarte. Qellim i qarte. Bere.", sub: "Pa kosto te fshehura, pa vonesa.", items: [] as never[] },
    funnel: { label: "Fillo nje Projekt", title: "Tregomë për projektin tënd", sub: "Plotëso formularin dhe do të të kthehem me një plan të qartë brenda 24 orëve.", fields: { name: "Emri yt", namePh: "Emri i plotë", email: "Email biznesi", emailPh: "ti@kompania.com", company: "Kompania ose emri i projektit", companyPh: "Emri i kompanise", service: "Cfare ke nevoje?", serviceOptions: ["Aplikacion Mobil", "Landing Page", "Platforme Web", "Backend i Personalizuar", "Nuk jam i sigurt — le te flasim"], budget: "Buxheti", budgetOptions: ["Nen €500", "€500 – €1,500", "€1,500 – €3,000", "€3,000+", "Nuk jam i sigurt"], timeline: "Kur ke nevoje?", timelineOptions: ["Sa me shpejt", "Brenda nje muaji", "2–3 muaj", "Pa ngutje"], description: "Tregomë per projektin", descriptionPh: "Cfare po nderton dhe per kend eshte?", submit: "Dergo brifin tim", submitting: "Duke derguar..." }, success: { title: "Morra — do te kontaktoj shpejt.", sub: "Do ta shqyrtoj brifin tuaj brenda 24 oreve." } },
    work: { label: "Punime te Zgjedhura", title: "Projekte reale. Rezultate reale.", projects: [] as never[] },
    stats: [] as never[], process: { label: "", title: "", steps: [] as never[] }, testimonials: [] as never[],
    about: { label: "", title: "", sub: "", bio: [] as never[], skills: [] as never[], experience: [] as never[], values: [] as never[] },
    blog: { label: "", title: "", sub: "", readMore: "Lexo postimin", minRead: "min lexim", categories: [] as never[], posts: [] as never[] },
    contact: { label: "Kontakt", title: "Kontaktomë", sub: "Tregomë për projektin tënd dhe do të kthehem brenda 24 orëve.", form: { name: "Emri yt", namePh: "Emri i plote", email: "Adresa email", emailPh: "ti@shembull.com", subject: "Subjekti", subjectPh: "Kerkese projekti", message: "Mesazhi", messagePh: "Tregomë për projektin tënd...", send: "Dërgo mesazhin", sending: "Duke dërguar...", sent: "Mesazhi u dërgua.", sentSub: "Do të kthehem brenda 24 orëve.", another: "Dergoni nje mesazh tjeter" }, chat: { intro: "Formular i shpejtë", greeting: "Përshëndetje — jam asistenti i pritjes së KIQA. Tri pyetje të shpejta dhe ia dërgoj Kristianit.", qService: "Çfarë pune ke nevojë?", qTimeline: "Kur ke nevojë?", qDescription: "Më trego pak për projektin.", descriptionPh: "Çfarë po ndërton dhe si duket një rezultat i mirë?", qName: "Bukur — si e ke emrin?", namePh: "Emri i plotë", qMethod: "Gjë e fundit — si duhet të të kontaktojë Kristiani?", methodEmail: "Email", methodPhone: "Telefon", emailPh: "ti@shembull.com", phonePh: "+355 6X XXX XXXX", submit: "Dërgo te Kristiani", sending: "Duke dërguar...", typing: "duke shkruar", summaryIntro: "Ja çfarë kam mbledhur:", restart: "Fillo nga fillimi", switchMethod: "Kalo te" }, info: { email: "contact@kiqa-dev.it", discord: "@kodibkfg", github: "github.com/rashica07", location: "Kosove / Itali", response: "Brenda 24 oreve" } },
  ...
  de: {
    ...
    funnel: { label: "Projekt starten", title: "Erzähl mir von deinem Projekt", sub: "Füll das Formular aus und ich melde mich innerhalb von 24 Stunden.", fields: { name: "Dein Name", namePh: "Vollständiger Name", email: "Geschäftliche E-Mail", emailPh: "du@unternehmen.de", company: "Unternehmen oder Projektname", companyPh: "Muster GmbH", service: "Was brauchst du?", serviceOptions: ["Mobile App", "Landing Page", "Web-Plattform", "Individuelles Backend", "Noch unsicher — lass uns reden"], budget: "Budget", budgetOptions: ["Unter €500", "€500 – €1.500", "€1.500 – €3.000", "€3.000+", "Noch unsicher"], timeline: "Wann brauchst du es?", timelineOptions: ["So schnell wie möglich", "Innerhalb eines Monats", "2–3 Monate", "Kein Zeitdruck"], description: "Beschreib mir das Projekt", descriptionPh: "Was baust du, für wen ist es?", submit: "Brief absenden", submitting: "Wird gesendet..." }, success: { title: "Erhalten — ich melde mich bald.", sub: "Ich werde dir innerhalb von 24 Stunden einen klaren Vorschlag schicken." } },
    work: { label: "Ausgewählte Projekte", title: "Echte Projekte. Echte Ergebnisse.", projects: [] as never[] },
    stats: [] as never[], process: { label: "", title: "", steps: [] as never[] }, testimonials: [] as never[],
    about: { label: "", title: "", sub: "", bio: [] as never[], skills: [] as never[], experience: [] as never[], values: [] as never[] },
    blog: { label: "", title: "", sub: "", readMore: "Artikel lesen", minRead: "Min. Lesezeit", categories: [] as never[], posts: [] as never[] },
    contact: { label: "Kontakt", title: "Schreib mir", sub: "Erzähl mir von deinem Projekt und ich melde mich innerhalb von 24 Stunden.", form: { name: "Dein Name", namePh: "Vollständiger Name", email: "E-Mail-Adresse", emailPh: "du@beispiel.de", subject: "Betreff", subjectPh: "Projektanfrage", message: "Nachricht", messagePh: "Erzähl mir von deinem Projekt...", send: "Nachricht senden", sending: "Wird gesendet...", sent: "Nachricht gesendet.", sentSub: "Ich melde mich innerhalb von 24 Stunden.", another: "Weitere Nachricht senden" }, chat: { intro: "Kurzer Fragebogen", greeting: "Hallo — ich bin der KIQA-Intake-Assistent. Drei kurze Fragen, dann leite ich alles an Kristian weiter.", qService: "Was für eine Arbeit brauchst du?", qTimeline: "Wie ist dein Zeitrahmen?", qDescription: "Erzähl mir kurz vom Projekt.", descriptionPh: "Was baust du und wie sieht ein gutes Ergebnis aus?", qName: "Schön — wie heißt du?", namePh: "Vollständiger Name", qMethod: "Letzte Frage — wie soll Kristian dich erreichen?", methodEmail: "E-Mail", methodPhone: "Telefon", emailPh: "du@beispiel.de", phonePh: "+355 6X XXX XXXX", submit: "An Kristian senden", sending: "Wird gesendet...", typing: "schreibt", summaryIntro: "Das habe ich notiert:", restart: "Neu starten", switchMethod: "Wechseln zu" }, info: { email: "contact@kiqa-dev.it", discord: "@kodibkfg", github: "github.com/rashica07", location: "Kosovo / Italien", response: "Innerhalb von 24 Stunden" } },
