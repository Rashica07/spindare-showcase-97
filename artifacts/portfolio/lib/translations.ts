// All site copy, per language. Plain data (no 'use client'), so server code
// such as route metadata can read it too; lib/i18n.tsx provides it to the UI.
...
export const translations = {
  en: {
    ...
    funnel: {
      ...
      sub: "Answer a few quick questions and I'll come back to you with a clear plan within 24 hours.",
    ...
    about: {
      ...
      ctaSub: "Currently open to new freelance projects.",
    ...
    contact: {
      ...
      chat: {
        intro: "Quick intake",
        greeting: "Hi! A few quick questions and this goes straight to Kristian.",
        ...
        qMethod: "Last thing. What's your email?",
        methodEmail: "Email",
        methodPhone: "Phone",
  ...
  it: {
    ...
    hero: { badge: "Disponibile per nuovi progetti · Kosovo / Italia", h1Line1: "App e siti web,", h1Line2: "online in poche settimane.", h1Line3: "Prezzo fisso,",
      h1Line4: "concordato in anticipo.", sub: "Sono Kristian, sviluppatore freelance tra Kosovo e Italia. Creo app mobile, landing page e piattaforme web per fondatori e piccole imprese. Hai un unico referente e una data di consegna messa per iscritto.", cta1: "Parlami del tuo progetto", cta2: "Guarda i miei lavori", available: "Disponibile per nuovi progetti" },
    services: {
    ...
    about: {
      ...
      ctaSub: "Attualmente disponibile per nuovi progetti freelance.",
    ...
    contact: { label: "Contatti", title: "Scrivimi", sub: "Parlami del tuo progetto e ti rispondo entro 24 ore.",
      ...
      chat: { intro: "Modulo rapido", greeting: "Ciao! Qualche domanda veloce e tutto arriva direttamente a Kristian.", qService: "Di cosa hai bisogno?", qTimeline: "Quando ne hai bisogno?", qDescription: "Raccontami un po' del progetto.", descriptionPh: "Cosa stai costruendo e come si presenta un buon risultato?", qName: "Perfetto. Come ti chiami?", namePh: "Nome completo", qMethod: "Ultima cosa. Qual è la tua email?", methodEmail: "Email", methodPhone: "Telefono", emailPh: "tu@esempio.com", phonePh: "+39 3XX XXX XXXX", submit: "Invia a Kristian", sending: "Invio in corso...", typing: "sta scrivendo", summaryIntro: "Ecco cosa ho raccolto:", restart: "Ricomincia", switchMethod: "Passa a",
  ...
  sq: {
    ...
    about: {
      ...
      ctaSub: "Aktualisht i hapur për projekte të reja freelance.",
    ...
    contact: { label: "Kontakti", title: "Kontaktomë", sub: "Tregomë për projektin tënd dhe do të kthehem brenda 24 orëve.",
      ...
      chat: { intro: "Formular i shpejtë", greeting: "Përshëndetje! Disa pyetje të shpejta dhe gjithçka i shkon direkt Kristianit.", qService: "Çfarë pune ke nevojë?", qTimeline: "Kur ke nevojë?", qDescription: "Më trego pak për projektin.", descriptionPh: "Çfarë po ndërton dhe si duket një rezultat i mirë?", qName: "Bukur. Si e ke emrin?", namePh: "Emri i plotë", qMethod: "Gjë e fundit. Cili është emaili yt?", methodEmail: "Email", methodPhone: "Telefon", emailPh: "ti@shembull.com", phonePh: "+383 4X XXX XXX", submit: "Dërgo te Kristiani", sending: "Duke dërguar...", typing: "duke shkruar", summaryIntro: "Ja çfarë kam mbledhur:", restart: "Fillo nga fillimi", switchMethod: "Kalo te",
  ...
  de: {
    ...
    hero: { badge: "Verfügbar für neue Projekte · Kosovo / Italien", h1Line1: "Apps und Websites,", h1Line2: "live in wenigen Wochen.", h1Line3: "Festpreis,",
      h1Line4: "vorab vereinbart.", sub: "Ich bin Kristian, freiberuflicher Entwickler zwischen Kosovo und Italien. Ich baue mobile Apps, Landing Pages und Web-Plattformen für Gründer und kleine Unternehmen. Du hast einen Ansprechpartner und einen schriftlich zugesagten Liefertermin.", cta1: "Erzähl mir von deinem Projekt", cta2: "Meine Projekte ansehen", available: "Aktuell offen für neue Projekte" },
    services: {
    ...
    about: {
      ...
      ctaSub: "Aktuell offen für neue Freelance-Projekte.",
    ...
    contact: { label: "Kontakt", title: "Schreib mir", sub: "Erzähl mir von deinem Projekt und ich melde mich innerhalb von 24 Stunden.",
      ...
      chat: { intro: "Kurzer Fragebogen", greeting: "Hallo! Ein paar kurze Fragen, dann geht alles direkt an Kristian.", qService: "Was für eine Arbeit brauchst du?", qTimeline: "Wie ist dein Zeitrahmen?", qDescription: "Erzähl mir kurz vom Projekt.", descriptionPh: "Was baust du und wie sieht ein gutes Ergebnis aus?", qName: "Schön. Wie heißt du?", namePh: "Vollständiger Name", qMethod: "Letzte Frage. Wie lautet deine E-Mail?", methodEmail: "E-Mail", methodPhone: "Telefon", emailPh: "du@beispiel.de", phonePh: "+49 1XX XXXX XXXX", submit: "An Kristian senden", sending: "Wird gesendet...", typing: "schreibt", summaryIntro: "Das habe ich notiert:", restart: "Neu starten", switchMethod: "Wechseln zu",
...
export const merged: Record<Lang, Translations> = {
  en: translations.en,
