...
const en = {
  ...
  about: {
    hero: {
      ...
      sub: "Developer. Builder. 14 years old.",
    },
    bio: {
      title: "Background",
      p1: "I'm Kristian — known online as Kiqa. I started coding at 11 out of pure curiosity and haven't stopped since. I'm 14, from Kosovo, currently living in Italy.",
      p2: "I'm the UI/UX lead on Spindare, a daily challenge social app built by a 3-person team. The codebase is 150k+ lines, and it ships to the App Store in September 2026. Building something that real, that big, at this age — that's my CV.",
      p3: "I started KIQA DEV to offer professional development services to businesses and founders who need someone who actually ships. I learn by doing, and I've been doing this long enough that I do it well.",
    },
    skills: {
      title: "Tech Stack",
      categories: [
        {
          name: "Mobile",
          items: ["React Native", "Expo", "iOS/Android", "App Store Deployment"],
        },
        {
          name: "Frontend",
          items: ["TypeScript", "Next.js", "React", "Framer Motion", "CSS"],
        },
        {
          name: "Backend",
          items: ["Supabase", "Node.js", "PostgreSQL", "REST APIs", "Clerk"],
        },
        {
          name: "Tools",
          items: ["Git", "Vercel", "Figma", "Cloudflare", "Backblaze B2"],
        },
      ],
    },
    experience: {
      title: "Experience",
      items: [
        { year: "2025–2026", role: "UI/UX Lead — Spindare", desc: "Leading all frontend and mobile development on a 3-person team. 300+ components, 150k+ lines of React Native." },
        { year: "2026", role: "Founder — KIQA DEV", desc: "Building professional development services for businesses and startups." },
        { year: "2026", role: "Solo Developer — TravelMe", desc: "Designing and building an AI-powered travel planner from scratch." },
        { year: "2022–2024", role: "Self-taught Developer", desc: "Learned React, TypeScript, Node.js, and mobile development through building real projects." },
      ],
    },
    values: {
      title: "How I work",
      items: [
        { title: "Ship fast, ship clean", desc: "Speed without quality is just debt. I do both." },
        { title: "No tutorials, only projects", desc: "Everything I know, I learned by building something real." },
        { title: "Honest communication", desc: "I tell you what I can build, when, and for how much. No surprises." },
